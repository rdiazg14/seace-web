...
import { ComponenteChip } from './ObservabilidadBlocks'
import {
  COMPONENTE_LABEL,
  TIPO_LABEL,
  fmtNum,
...
export function SeccionConsumoIa({
  uso,
  usoErr,
  usoLoading,
  usoDesde,
  ...
  compFiltro: string
  modelos: string[]
  setUsoDesde: (v: string) => void
  setUsoHasta: (v: string) => void
  setModeloFiltro: (v: string) => void
  setCompFiltro: (v: string) => void
  loadUso: () => Promise<void>
  compBars: BarraComponente[]
  donut: PuntoDonut[]
  axis: string
  grid: string
  tipBg: string
